...
include "m8c.inc"
include "PWM8_GREEN.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWM8_GREEN_EnableInt
export _PWM8_GREEN_EnableInt
export  PWM8_GREEN_DisableInt
export _PWM8_GREEN_DisableInt
export  PWM8_GREEN_Start
export _PWM8_GREEN_Start
export  PWM8_GREEN_Stop
export _PWM8_GREEN_Stop
export  PWM8_GREEN_WritePeriod
export _PWM8_GREEN_WritePeriod
export  PWM8_GREEN_WritePulseWidth
export _PWM8_GREEN_WritePulseWidth
export  PWM8_GREEN_bReadPulseWidth
export _PWM8_GREEN_bReadPulseWidth
export  PWM8_GREEN_bReadCounter
export _PWM8_GREEN_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_GREEN_ReadPulseWidth    ; deprecated
export _bPWM8_GREEN_ReadPulseWidth    ; deprecated
export  bPWM8_GREEN_ReadCounter       ; deprecated
export _bPWM8_GREEN_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_GREEN_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_GREEN_EnableInt:
_PWM8_GREEN_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_GREEN_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_GREEN_DisableInt
;
;  DESCRIPTION:
...
_PWM8_GREEN_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_GREEN_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_GREEN_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_GREEN_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_GREEN_WritePeriod:
_PWM8_GREEN_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_GREEN_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_GREEN_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_GREEN_WritePulseWidth:
_PWM8_GREEN_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_GREEN_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_GREEN_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_GREEN_bReadPulseWidth:
_PWM8_GREEN_bReadPulseWidth:
 bPWM8_GREEN_ReadPulseWidth:                     ; this name deprecated
_bPWM8_GREEN_ReadPulseWidth:                     ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_GREEN_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_GREEN_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_GREEN_bReadCounter:
_PWM8_GREEN_bReadCounter:
 bPWM8_GREEN_ReadCounter:                        ; this name deprecated
_bPWM8_GREEN_ReadCounter:                        ; this name deprecated
   ...
   mov   A, reg[PWM8_GREEN_COMPARE_REG]          ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_GREEN_Stop_M                             ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_GREEN_INPUT_REG]            ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_GREEN_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_GREEN_COUNTER_REG]          ; DR2 <- DR0
   mov   A, reg[PWM8_GREEN_COMPARE_REG]          ; Stash the Count on the stack
   ...
   mov   reg[PWM8_GREEN_INPUT_REG], A            ;
   M8C_SetBank0                                  ;
   PWM8_GREEN_Start_M                            ;   then re-enable the PWM.
