...
include "m8c.inc"
include "PWM8_RED.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWM8_RED_EnableInt
export _PWM8_RED_EnableInt
export  PWM8_RED_DisableInt
export _PWM8_RED_DisableInt
export  PWM8_RED_Start
export _PWM8_RED_Start
export  PWM8_RED_Stop
export _PWM8_RED_Stop
export  PWM8_RED_WritePeriod
export _PWM8_RED_WritePeriod
export  PWM8_RED_WritePulseWidth
export _PWM8_RED_WritePulseWidth
export  PWM8_RED_bReadPulseWidth
export _PWM8_RED_bReadPulseWidth
export  PWM8_RED_bReadCounter
export _PWM8_RED_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_RED_ReadPulseWidth    ; deprecated
export _bPWM8_RED_ReadPulseWidth    ; deprecated
export  bPWM8_RED_ReadCounter       ; deprecated
export _bPWM8_RED_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_RED_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_RED_DisableInt
;
;  DESCRIPTION:
...
;
 PWM8_RED_DisableInt:
_PWM8_RED_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_RED_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_RED_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_RED_WritePeriod:
_PWM8_RED_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_RED_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_RED_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_RED_WritePulseWidth:
_PWM8_RED_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_RED_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_RED_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_RED_bReadPulseWidth:
_PWM8_RED_bReadPulseWidth:
 bPWM8_RED_ReadPulseWidth:                       ; this name deprecated
_bPWM8_RED_ReadPulseWidth:                       ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_RED_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_RED_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_RED_bReadCounter:
_PWM8_RED_bReadCounter:
 bPWM8_RED_ReadCounter:                          ; this name deprecated
_bPWM8_RED_ReadCounter:                          ; this name deprecated
   ...
   mov   A, reg[PWM8_RED_COMPARE_REG]            ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_RED_Stop_M                               ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_RED_INPUT_REG]              ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_RED_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_RED_COUNTER_REG]            ; DR2 <- DR0
   mov   A, reg[PWM8_RED_COMPARE_REG]            ; Stash the Count on the stack
   ...
   mov   reg[PWM8_RED_INPUT_REG], A              ;
   M8C_SetBank0                                  ;
   PWM8_RED_Start_M                              ;   then re-enable the PWM.
