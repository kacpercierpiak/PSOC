...
export LoadConfig_firstproject
export _LoadConfig_firstproject
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_firstproject
	lcall	LoadConfigTBL_firstproject_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration firstproject
;
;    Load configuration registers for firstproject.
...
;               CUR_PP
;
_LoadConfig_firstproject:
 LoadConfig_firstproject:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_firstproject_Bank0
    mov     X, <LoadConfigTBL_firstproject_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_firstproject_Bank1
    mov     X, <LoadConfigTBL_firstproject_Bank1
