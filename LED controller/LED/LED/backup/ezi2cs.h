...
#define EzI2Cs_CY8C22x45                  0                          // 1 if it is CY8C22x45 device, otherwice 0
...
#if (EzI2Cs_CY8C22x45)
#pragma fastcall16  EzI2Cs_EnableHWAddrCheck
#pragma fastcall16  EzI2Cs_DisableHWAddrCheck
#endif
...
#if ( EzI2Cs_CY8C22x45 ) 
extern void  EzI2Cs_EnableHWAddrCheck(void);
extern void  EzI2Cs_DisableHWAddrCheck(void);
#endif
