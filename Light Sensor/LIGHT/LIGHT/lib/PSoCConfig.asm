...
export LoadConfig_MF_LIGHT
export _LoadConfig_MF_LIGHT
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_MF_LIGHT
	lcall	LoadConfigTBL_MF_LIGHT_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration MF_LIGHT
;
;    Load configuration registers for MF_LIGHT.
...
_LoadConfig_MF_LIGHT:
 LoadConfig_MF_LIGHT:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_MF_LIGHT_Bank0
    mov     X, <LoadConfigTBL_MF_LIGHT_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_MF_LIGHT_Bank1
    mov     X, <LoadConfigTBL_MF_LIGHT_Bank1
