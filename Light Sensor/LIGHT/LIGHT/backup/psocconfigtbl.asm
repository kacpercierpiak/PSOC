...
export LoadConfigTBL_MF_LIGHT_Bank1
export LoadConfigTBL_MF_LIGHT_Bank0
export LoadConfigTBL_MF_LIGHT_Ordered
AREA lit(rom, rel)
LoadConfigTBL_MF_LIGHT_Bank0:
...
;       Instance name ADC10, Block Name RAMP(ASE11)
	db		69h, 64h		;ADC10_ADC_CR(ADC1_CR)
...
;  Global Register values Bank 0
	db		60h, 0dh		; AnalogColumnInputSelect register (AMX_IN)
...
LoadConfigTBL_MF_LIGHT_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[04h], bch		; Port_1_DriveMode_0 register (PRT1DM0)
