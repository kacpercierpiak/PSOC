...
export LoadConfigTBL_MF_CS_SLIDE_Bank1
export LoadConfigTBL_MF_CS_SLIDE_Bank0
export LoadConfigTBL_MF_CS_SLIDE_Ordered
AREA lit(rom, rel)
LoadConfigTBL_MF_CS_SLIDE_Bank0:
...
;       Instance name PWM8_1, Block Name PWM8(DCB03)
	...
	db		2dh, 02h		;PWM8_1_PERIOD_REG(DCB03DR1)
	db		2eh, 01h		;PWM8_1_COMPARE_REG(DCB03DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_MF_CS_SLIDE_Bank1:
;  Instance name CSD, User Module CSD
;       Instance name CSD, Block Name CMP(ACE01)
;       Instance name CSD, Block Name CMP0(ACE00)
;       Instance name CSD, Block Name CMP_REF(ASE11)
...
;       Instance name PWM8_1, Block Name PWM8(DCB03)
	...
	db		2dh, 11h		;PWM8_1_INPUT_REG(DCB03IN)
	db		2eh, 06h		;PWM8_1_OUTPUT_REG(DCB03OU)
...
LoadConfigTBL_MF_CS_SLIDE_Ordered:
