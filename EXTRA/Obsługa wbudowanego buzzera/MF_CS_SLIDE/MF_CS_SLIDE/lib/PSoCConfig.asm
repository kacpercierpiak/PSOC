...
export LoadConfig_MF_CS_SLIDE
export _LoadConfig_MF_CS_SLIDE
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_MF_CS_SLIDE
	lcall	LoadConfigTBL_MF_CS_SLIDE_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration MF_CS_SLIDE
;
;    Load configuration registers for MF_CS_SLIDE.
...
;               CUR_PP
;
_LoadConfig_MF_CS_SLIDE:
 LoadConfig_MF_CS_SLIDE:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_MF_CS_SLIDE_Bank0
    mov     X, <LoadConfigTBL_MF_CS_SLIDE_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_MF_CS_SLIDE_Bank1
    mov     X, <LoadConfigTBL_MF_CS_SLIDE_Bank1
