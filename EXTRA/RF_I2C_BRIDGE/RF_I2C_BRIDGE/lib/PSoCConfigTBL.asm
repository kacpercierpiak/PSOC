...
export LoadConfigTBL_rf_i2c_bridge_Bank1
export LoadConfigTBL_rf_i2c_bridge_Bank0
export LoadConfigTBL_rf_i2c_bridge_Ordered
AREA lit(rom, rel)
LoadConfigTBL_rf_i2c_bridge_Bank0:
;  Instance name CYFISNP, User Module CYFISNP
;       Instance name CYFISNP, Block Name SPIM(DCB02)
	db		2bh, 00h		;CYFISNP_CONTROL_REG  (DCB02CR0)
	db		29h, 00h		;CYFISNP_TX_BUFFER_REG(DCB02DR1)
	db		2ah, 00h		;CYFISNP_RX_BUFFER_REG(DCB02DR2)
;  Instance name I2C, User Module I2CHW
...
;       Instance name Timer8, Block Name TIMER8(DBB00)
	...
	db		21h, ffh		;Timer8_PERIOD_REG(DBB00DR1)
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_rf_i2c_bridge_Bank1:
;  Instance name CYFISNP, User Module CYFISNP
;       Instance name CYFISNP, Block Name SPIM(DCB02)
	db		28h, 16h		;CYFISNP_FUNCTION_REG (DCB02FN)
	db		29h, c5h		;CYFISNP_INPUT_REG    (DCB02IN)
	db		2ah, 7dh		;CYFISNP_OUTPUT_REG   (DCB02OU)
;  Instance name I2C, User Module I2CHW
;  Instance name Timer8, User Module Timer8
;       Instance name Timer8, Block Name TIMER8(DBB00)
	db		20h, 20h		;Timer8_FUNC_REG(DBB00FN)
	db		21h, 07h		;Timer8_INPUT_REG(DBB00IN)
...
;  Global Register values Bank 1
	...
	db		e1h, 70h		; OscillatorControl_1 register (OSC_CR1)
...
LoadConfigTBL_rf_i2c_bridge_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[08h], a8h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], 57h		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], 16h		; Port_2_DriveMode_2 register (PRT2DM2)
	mov	reg[0ah], 29h		; Port_2_GlobalSelect register (PRT2GS)
	M8C_SetBank1
