...
export LoadConfig_rf_i2c_bridge
export _LoadConfig_rf_i2c_bridge
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_rf_i2c_bridge
	lcall	LoadConfigTBL_rf_i2c_bridge_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration rf_i2c_bridge
;
;    Load configuration registers for rf_i2c_bridge.
...
;               CUR_PP
;
_LoadConfig_rf_i2c_bridge:
 LoadConfig_rf_i2c_bridge:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_rf_i2c_bridge_Bank0
    mov     X, <LoadConfigTBL_rf_i2c_bridge_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_rf_i2c_bridge_Bank1
    mov     X, <LoadConfigTBL_rf_i2c_bridge_Bank1
