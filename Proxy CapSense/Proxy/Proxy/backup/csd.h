...
#define CSD_TotalSensorCount                      0x1
#define CSD_ButtonCount                           0x1
#define CSD_SliderCount                           0x0 + 0x0

#define CSD_BUTTONS_EXIST                         0x1
