...
;;*****************************************************************************
;;  FILENAME: EzI2Cs.asm
;;  Version: 2.00, Updated on 2015/3/4 at 22:26:14
...
IF (EzI2Cs_CY8C22x45)
export    EzI2Cs_EnableHWAddrCheck
export   _EzI2Cs_EnableHWAddrCheck
export    EzI2Cs_DisableHWAddrCheck
export   _EzI2Cs_DisableHWAddrCheck
ENDIF
...
IF (EzI2Cs_CY8C22x45)
   M8C_SetBank1
   mov   reg[EzI2Cs_ADDR_REG], (EzI2Cs_SLAVE_ADDR>>1)
   M8C_SetBank0
ENDIF
...
_EzI2Cs_EnableInt:
   ...
   M8C_ClearIntFlag INT_CLR3, EzI2Cs_INT_MASK   
ResumeEntry:
...
IF (EzI2Cs_CY8C22x45)
 .SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: void  EzI2Cs_EnableHWAddrCheck(void)
;
;  DESCRIPTION:
...
;    functions.
;
 EzI2Cs_EnableHWAddrCheck:
_EzI2Cs_EnableHWAddrCheck:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   or    reg[EzI2Cs_ADDR_REG], EzI2Cs_HW_ADDR_EN
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: void  EzI2Cs_DisableHWAddrCheck(void)
;
;  DESCRIPTION:
...
;    functions.
;
 EzI2Cs_DisableHWAddrCheck:
_EzI2Cs_DisableHWAddrCheck:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   reg[EzI2Cs_ADDR_REG], ~EzI2Cs_HW_ADDR_EN
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
