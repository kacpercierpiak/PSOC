...
export LoadConfig_MF_TEMP
export _LoadConfig_MF_TEMP
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_MF_TEMP
	lcall	LoadConfigTBL_MF_TEMP_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration MF_TEMP
;
;    Load configuration registers for MF_TEMP.
...
_LoadConfig_MF_TEMP:
 LoadConfig_MF_TEMP:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_MF_TEMP_Bank0
    mov     X, <LoadConfigTBL_MF_TEMP_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_MF_TEMP_Bank1
    mov     X, <LoadConfigTBL_MF_TEMP_Bank1
