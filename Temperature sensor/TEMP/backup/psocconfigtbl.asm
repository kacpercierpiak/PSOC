...
export LoadConfigTBL_MF_TEMP_Bank1
export LoadConfigTBL_MF_TEMP_Bank0
export LoadConfigTBL_MF_TEMP_Ordered
AREA lit(rom, rel)
LoadConfigTBL_MF_TEMP_Bank0:
...
;       Instance name ADC10, Block Name CNT(DBB00)
	db		23h, 00h		;ADC10_CNT_CR0(DBB00CR0)
	db		21h, 00h		;ADC10_CNT_DR1(DBB00DR1)
	db		22h, 00h		;ADC10_CNT_DR2(DBB00DR2)
...
;       Instance name PWM8, Block Name PWM8(DBB01)
	db		27h, 00h		;PWM8_CONTROL_REG(DBB01CR0)
	db		25h, f9h		;PWM8_PERIOD_REG(DBB01DR1)
	db		26h, 64h		;PWM8_COMPARE_REG(DBB01DR2)
;  Global Register values Bank 0
	db		60h, 03h		; AnalogColumnInputSelect register (AMX_IN)
	...
	db		ffh
LoadConfigTBL_MF_TEMP_Bank1:
;  Instance name ADC10, User Module ADC10
;       Instance name ADC10, Block Name ADC(ACE01)
;       Instance name ADC10, Block Name CNT(DBB00)
	db		20h, 21h		;ADC10_CNT_FN(DBB00FN)
	db		21h, 55h		;ADC10_CNT_IN(DBB00IN)
	db		22h, 40h		;ADC10_CNT_OUT(DBB00OU)
;       Instance name ADC10, Block Name RAMP(ASE11)
...
;  Instance name PWM8, User Module PWM8
;       Instance name PWM8, Block Name PWM8(DBB01)
	db		24h, 31h		;PWM8_FUNC_REG(DBB01FN)
	db		25h, 16h		;PWM8_INPUT_REG(DBB01IN)
	db		26h, 46h		;PWM8_OUTPUT_REG(DBB01OU)
;  Global Register values Bank 1
	...
	db		e1h, b7h		; OscillatorControl_1 register (OSC_CR1)
